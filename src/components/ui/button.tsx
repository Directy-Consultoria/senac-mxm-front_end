  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        // Borda neutra que destaca Laranja Senac no hover
        outline:
          "border border-border bg-background text-foreground hover:border-accent hover:text-accent hover:bg-accent/10",

        // Superfície secundária
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80",

        // Fantasma com Azul Senac
